...
public class TransitionTargetActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transition_target_1);

        ViewGroup container = (ViewGroup) findViewById(R.id.container_scenes_1);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            transitionScenetoSecond = TransitionInflater.from(this)
                    .inflateTransition(R.transition.scene1_transition1_scene2);

            transitionScenetoFirst = TransitionInflater.from(this)
                    .inflateTransition(R.transition.scene2_transition1_scene1);
